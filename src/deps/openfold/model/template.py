...
from src.deps.openfold.model.dropout import (
    DropoutColumnwise,
    DropoutRowwise,
)
from src.deps.openfold.model.pair_transition import PairTransition
from src.deps.openfold.model.primitives import Attention, LayerNorm
from src.deps.openfold.model.triangular_attention import (
    TriangleAttentionEndingNode,
    TriangleAttentionStartingNode,
)
from src.deps.openfold.model.triangular_multiplicative_update import (
    FusedTriangleMultiplicationIncoming,
    FusedTriangleMultiplicationOutgoing,
    TriangleMultiplicationIncoming,
    TriangleMultiplicationOutgoing,
)
from src.deps.openfold.utils.checkpointing import checkpoint_blocks
from src.deps.openfold.utils.chunk_utils import (
    ChunkSizeTuner,
    chunk_layer,
)
...
class TemplatePairStackBlock(nn.Module):
    ...
    def tri_mul_out_in(self, single: torch.Tensor, single_mask: torch.Tensor, inplace_safe: bool):
            ...
            if self.tri_mul_first:
                single = self.tri_att_start_end(
                    single=self.tri_mul_out_in(
                        single=single, single_mask=single_mask, inplace_safe=inplace_safe
                    ),
