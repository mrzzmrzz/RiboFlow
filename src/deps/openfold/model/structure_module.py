...
from src.deps.openfold.model.primitives import LayerNorm, Linear, ipa_point_weights_init_
from src.deps.openfold.np.residue_constants import (
    restype_atom14_mask,
    restype_atom14_rigid_group_positions,
    restype_atom14_to_rigid_group,
    restype_rigid_group_default_frame,
)
from src.deps.openfold.utils.feats import (
    frames_and_literature_positions_to_atom14_pos,
    torsion_angles_to_frames,
)
from src.deps.openfold.utils.geometry.quat_rigid import QuatRigid
from src.deps.openfold.utils.geometry.rigid_matrix_vector import Rigid3Array
from src.deps.openfold.utils.geometry.vector import Vec3Array, square_euclidean_distance
from src.deps.openfold.utils.precision_utils import is_fp16_enabled
from src.deps.openfold.utils.rigid_utils import Rigid, Rotation
from src.deps.openfold.utils.tensor_utils import (
    dict_multimap,
    flatten_final_dims,
    permute_final_dims,
)
...
class InvariantPointAttention(nn.Module):
    ...
    def __init__(
        ...
        if is_multimer:
            ...
            self.linear_kv_points = PointProjection(
                self.c_s, self.no_qk_points + self.no_v_points, self.no_heads, self.is_multimer
            )
    ...
    def forward(
        ...
        # [*, N_res, C_s]
        s = self.linear_out(torch.cat((o, *o_pt, o_pt_norm, o_pair), dim=-1).to(dtype=z[0].dtype))
