...
import src.deps.openfold.np.residue_constants as residue_constants
from src.deps.openfold.data import data_transforms_multimer
from src.deps.openfold.model.embedders import (
    ExtraMSAEmbedder,
    InputEmbedder,
...
from src.deps.openfold.model.evoformer import EvoformerStack, ExtraMSAStack
from src.deps.openfold.model.heads import AuxiliaryHeads
from src.deps.openfold.model.structure_module import StructureModule
from src.deps.openfold.model.template import (
    TemplatePairStack,
...
from src.deps.openfold.utils.loss import (
    compute_plddt,
)
...
class AlphaFold(nn.Module):
    ...
    def iteration(self, feats, prevs, _recycle=True):
        ...
        pseudo_beta_x_prev = pseudo_beta_fn(feats["aatype"], x_prev, None).to(dtype=z.dtype)
