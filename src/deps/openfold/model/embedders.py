...
from src.deps.openfold.utils import all_atom_multimer, geometry
...
from src.deps.openfold.utils.tensor_utils import add, dict_multimap, one_hot, tensor_tree_map
...
class TemplatePairEmbedderMultimer(nn.Module):
    ...
    def forward(
        ...
        x, y, z = [
            (coord * backbone_mask_2d).to(dtype=query_embedding.dtype) for coord in unit_vector
        ]
