...
from src.deps.openfold.np.residue_constants import restypes
    ...
    def __init__(
        ...
        Args:
            ...
            alignment_dir:
                ...
                (defined in src.deps.openfold.features.alignment_runner).
            ...
            config:
                A dataset config object. See src.deps.openfold.config
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.training_mode and train_alignment_dir is None:
            ...
            raise ValueError(
                "If val_data_dir is specified, val_alignment_dir must be specified as well"
            )
