...
from src.deps.openfold.config import NUM_EXTRA_SEQ, NUM_MSA_SEQ, NUM_RES, NUM_TEMPLATES
from src.deps.openfold.np import residue_constants as rc
from src.deps.openfold.utils.geometry.rigid_matrix_vector import Rigid3Array
from src.deps.openfold.utils.geometry.rotation_matrix import Rot3Array
from src.deps.openfold.utils.geometry.vector import Vec3Array
...
def make_msa_feat(protein):
    ...
    if "extra_deletion_matrix" in protein:
        ...
        protein["extra_deletion_value"] = torch.atan(protein["extra_deletion_matrix"] / 3.0) * (
            2.0 / np.pi
        )
