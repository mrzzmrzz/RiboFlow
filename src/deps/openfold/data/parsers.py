...
def parse_stockholm(stockholm_string: str) -> Msa:
    ...
    return Msa(
        sequences=msa, deletion_matrix=deletion_matrix, descriptions=list(name_to_sequence.keys())
    )
...
def parse_a3m(a3m_string: str) -> Msa:
    ...
    return Msa(
        sequences=aligned_sequences, deletion_matrix=deletion_matrix, descriptions=descriptions
    )
