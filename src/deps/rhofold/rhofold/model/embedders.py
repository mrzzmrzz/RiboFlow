...
import src.deps.rhofold.rhofold.model.rna_fm as rna_esm
from src.deps.rhofold.rhofold.model.msa import MSANet
from src.deps.rhofold.rhofold.model.pair import PairNet
from src.deps.rhofold.rhofold.model.primitives import LayerNorm, Linear
from src.deps.rhofold.rhofold.utils.alphabet import RNAAlphabet
...
class MSAEmbedder(nn.Module):
    ...
    def forward(self, tokens, rna_fm_tokens=None, is_BKL=True, **unused):
        ...
        if exists(self.rna_fm):
            results = self.rna_fm(
                rna_fm_tokens, need_head_weights=False, repr_layers=[12], return_contacts=False
            )
