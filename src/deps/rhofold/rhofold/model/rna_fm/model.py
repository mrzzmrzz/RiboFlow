...
from src.deps.rhofold.rhofold.model.rna_fm.axial_attention import (
    ColumnSelfAttention,
    RowSelfAttention,
)
from src.deps.rhofold.rhofold.model.rna_fm.modules import (
...
def init_bert_params(module):
    ...
    if (
        ...
        or isinstance(module, RowSelfAttention)
        or isinstance(module, ColumnSelfAttention)
    ):
...
class MSATransformer(nn.Module):
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument("--dropout", default=0.1, type=float, help="Dropout to apply.")
        parser.add_argument(
            "--attention_dropout", default=0.1, type=float, help="Dropout to apply."
        )
        parser.add_argument(
            "--activation_dropout", default=0.1, type=float, help="Dropout to apply."
        )
        parser.add_argument(
            "--max_tokens_per_msa",
            default=2**14,
