...
from src.deps.rhofold.rhofold.utils.converter import RNAConverter
from src.deps.rhofold.rhofold.utils.rigid_utils import Rigid
from src.deps.rhofold.rhofold.utils.tensor_utils import (
    dict_multimap,
    flatten_final_dims,
    permute_final_dims,
)
...
class EGNN(torch.nn.Module):
    ...
    def forward(self, feats, coors):
        ...
        scale_factor = 1 / 50.0
        coors_out = (
            torch.einsum("b i j, b i j c -> b i c", coor_weights * scale_factor, rel_coors)
            + coors
        )
