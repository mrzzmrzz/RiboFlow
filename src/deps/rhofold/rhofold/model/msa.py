...
from src.deps.rhofold.rhofold.model.primitives import (
    Attention,
    GlobalAttention,
    LayerNorm,
    Linear,
...
from src.deps.rhofold.rhofold.utils.chunk_utils import chunk_layer
...
class MSANet(nn.Module):
    def __init__(
        self, d_model=64, d_msa=21, padding_idx=None, max_len=4096, is_pos_emb=True, **unused
    ):
