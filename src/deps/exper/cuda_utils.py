...
def cuda(obj, *args, **kwargs):
    ...
    if hasattr(obj, "cuda"):
        ...
        return type(obj)({k: cuda(v, *args, **kwargs) for k, v in obj.items()})  # type: ignore
    elif isinstance(obj, Sequence):
        return type(obj)(cuda(x, *args, **kwargs) for x in obj)  # type: ignore
...
def mean(obj, *args, **kwargs):
    ...
    if hasattr(obj, "mean"):
        ...
        return type(obj)({k: mean(v, *args, **kwargs) for k, v in obj.items()})  # type: ignore
    elif isinstance(obj, Sequence):
        return type(obj)(mean(x, *args, **kwargs) for x in obj)  # type: ignore
...
def cat(objs: list[object], *args, **kwargs):
    ...
    if is_tensor_list(objs):
        ...
        return type(objs[0])({k: cat([x[k] for x in objs], *args, **kwargs) for k in objs[0]})  # type: ignore
    elif is_sequence_list(objs):
        return type(objs[0])(cat(xs, *args, **kwargs) for xs in zip(*objs))  # type: ignore
...
def stack(objs: Sequence[object], *args, **kwargs):
    ...
    if is_tensor_list(objs):
        ...
        return type(objs[0])({k: stack([x[k] for x in objs], *args, **kwargs) for k in objs[0]})  # type: ignore
    elif is_sequence_list(objs):
        return type(objs[0])(stack(xs, *args, **kwargs) for xs in zip(*objs))  # type: ignore
