...
from src.model.flow.helpers.so3_helpers import rotvec_to_rotmat, so3_exp_map
...
def f_igso3_small(omega, sigma):
    """Borrowed from:
        https://github.com/tomato1mule/edf/blob/1dd342e849fcb34d3eb4b6ad2245819abbd6c812/edf/dist.py#L99
...
def _batch_sample(mu, eps, n):
    aa_samples = (
        vmap(_sample, in_dims=(0, None), randomness="different")(eps, n).squeeze().double()
    )
