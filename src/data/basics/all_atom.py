...
from src.deps.openfold.data import data_transforms
from src.deps.openfold.np import residue_constants
from src.deps.openfold.utils import rigid_utils as ru


Rigid: TypeAlias = ru.Rigid
Rotation: TypeAlias = ru.Rotation
