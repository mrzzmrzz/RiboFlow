...
from src.data.basics.constants import nucleotide_constants, vocabulary
from src.data.basics.constants.complex_constants import NUM_NA_TORSIONS, NUM_PROT_NA_TORSIONS


# fmt:off
IDEALIZED_NA_ATOM_POS27 = torch.tensor(nucleotide_constants.nttype_atom27_rigid_group_positions)
IDEALIZED_NA_ATOM_POS27_MASK = torch.any(IDEALIZED_NA_ATOM_POS27, dim=-1)
IDEALIZED_NA_ATOM_POS23 = torch.tensor(nucleotide_constants.nttype_compact_atom_rigid_group_positions)
...
IDX_2_NATYPE = {0: "A", 1: "C", 2: "G", 3: "U"}
NATYPE_2_IDX = {"A": 0, "C": 1, "G": 2, "U": 3}
# fmt:on
...
def compute_backbone(bb_rigids, torsions, is_na_residue_mask, aatype=None):
    ...
    if na_inputs_present:
        ...
        """
        masked_angles = torsions.view(torsions.shape[0], -1, 8, 2)  # [N_res, 11, 8, 2]
    ...
    if na_inputs_present:
        ...
        na_torsion_angles = torsion_angles.view(
    ...
    if na_inputs_present:
        # fmt: off
        # NA atom23 bb order = ['C3'', 'C4'', 'O4'', 'C2'', 'C1'', 'C5'', 'O3'', 'O5'', 'P', 'OP1', 'OP2', 'N9', ...]
        # NA atom37 bb order = ['C1'', 'C2'', 'C3'', 'C4'', 'C5'', '05'', '04'', 'O3'', 'O2'', 'P', 'OP1', 'OP2', 'N1', 'N2', 'N3', 'N4', 'N6', 'N7', 'N9', ...]
